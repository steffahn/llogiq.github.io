...
This post is based on my [RustNationUK '24](https://rustnationuk.com) talk with the same title. The the talk is available on YouTube [here](https://www.youtube.com/watch?v=33FG6O3qejM) and the slides are [here](/talks/easy.html).
